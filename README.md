...
* **All three species show positive correlations among the four morphological variables** (bill length, bill depth, flipper length, and body mass).  
  These patterns also suggest that morphological measurements can be used to distinguish male and female penguins, with each species relying on different key traits.
...
🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧
🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧🐧
(Here are the 200 penguins included in the analysis, with gratitude to each of them)
